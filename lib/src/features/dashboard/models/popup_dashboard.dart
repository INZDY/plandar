...
class _PopupDashboardState extends State<PopupDashboard> {
  ...
  void initState() {
    ...
    EventDetails event = widget.eventDetail;
    ...
    setState(() {
      ...
      startHours = startDate.hour.toString().padLeft(2, '0');
      startMins = startDate.minute.toString().padLeft(2, '0');
      endHours = endDate.hour.toString().padLeft(2, '0');
      endMins = endDate.minute.toString().padLeft(2, '0');
      finalColor = event.tag;
